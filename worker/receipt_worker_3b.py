...
NUM_CTX = 16384                     # длина контекста (увеличено для длинных счетов; в VRAM влезает)
KEEP_ALIVE = -1                       # -1 = держать модель в VRAM вечно
NUM_GPU = 36                          # КОЛ-ВО СЛОЁВ модели на видеокарту. qwen2.5vl:3b = 36 слоёв (все на GPU). Уменьши, если не влезает в VRAM
