...
NUM_CTX = 32768                     # длина контекста (большая — для длинных счетов ДНС и т.п.; в VRAM влезает)
KEEP_ALIVE = -1                       # -1 = держать модель в VRAM вечно
NUM_GPU = 28                          # КОЛ-ВО СЛОЁВ модели на видеокарту. qwen2.5vl:7b = 28 слоёв (все на GPU). Уменьши, если не влезает в VRAM
