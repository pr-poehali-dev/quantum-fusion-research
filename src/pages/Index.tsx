...
export default function Index() {
  ...
  const { getShaderColors, mode: savedMode, getAccent, accentId } = useTheme()
  const shaderColors = getShaderColors()

  // Принудительно тёмная тема на главной, восстанавливаем при уходе
  useEffect(() => {
    ...
    return () => {
      // Восстанавливаем сохранённую тему при уходе со страницы
      if (savedMode === "light") {
  ...
  }, [accentId]) // eslint-disable-line react-hooks/exhaustive-deps
