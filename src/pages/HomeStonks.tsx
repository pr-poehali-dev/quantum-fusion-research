...
const BANNER_RAZGON = "https://cdn.poehali.dev/projects/63b26282-df0d-46e2-bce8-199a865a9659/bucket/214a73ee-c5ac-44a4-abab-603223e4e175.jpg"
...
export default function HomeStonks() {
  ...
  const Banner = ({ img, title, to }: { img: string; title: string; to: string }) => (
    <button onClick={() => navigate(to)} style={{ cursor: "pointer" }}
      ...
      <img src={img} alt={title} className="absolute inset-0 h-full w-full object-cover object-top transition-transform duration-500 group-hover:scale-105" />
