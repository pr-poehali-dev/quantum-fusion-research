...
export type AdminTab = "orders" | "orders_archive" | "wip_builds" | "wip_archive" | "products" | "add_product" | "builds" | "archive" | "add_build" | "tags" | "articles" | "add_article" | "warehouse" | "sn_archive" | "compatibility" | "users" | "schedule" | "calendar" | "finance" | "cables" | "rma" | "quiz_requests"
export const VALID_TABS: AdminTab[] = ["orders", "orders_archive", "wip_builds", "wip_archive", "products", "add_product", "builds", "archive", "add_build", "tags", "articles", "add_article", "warehouse", "sn_archive", "compatibility", "users", "schedule", "calendar", "finance", "cables", "rma", "quiz_requests"]
