        ...
        <div className="grid gap-8 md:grid-cols-2 md:gap-16 lg:gap-24">
          ...
          <div>
            ...
            >
              <h2 className="mb-3 font-sans text-3xl font-light leading-[1.1] tracking-tight text-foreground md:mb-4 md:text-6xl lg:text-7xl">
                ...
                без
                <br />
                <span className="text-foreground/40">компромиссов</span>
              </h2>
            </div>
            ...
            >
              <p className="max-w-md text-sm leading-relaxed text-foreground/90 md:text-lg">
                Мы команда энтузиастов и профессионалов, которые знают железо от и до. Помогаем выбрать, собрать и настроить идеальный ПК.
              </p>
              <p className="max-w-md text-sm leading-relaxed text-foreground/90 md:text-lg">
                Работаем только с проверенными брендами и даём гарантию на каждую сборку. Никаких переплат — только честная цена.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col justify-center space-y-6 md:space-y-12">
            {[
              ...
              { value: "до 10", label: "Лет гарантии*", sublabel: "На каждую сборку под заказ", direction: "right" },
            ].map((stat, i) => {
