...
const PRESETS: Preset[] = [
  ...
  {
    key: "furmark",
    label: "FurMark (открыть)",
    hint: "Открывает окно FurMark — выбери разрешение и нажми «GPU stress test». Это лучший прогрев видеокарты. Температуры снимутся через HWiNFO.",
    make: () => ({
      ...emptyTest(),
      name: "FurMark — ручной старт",
