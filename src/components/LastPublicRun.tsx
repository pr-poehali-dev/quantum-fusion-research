...
// Витрина «последний тест» на публичной странице программы.
// Показываем как в админке, но без датчиков: посетителю важно увидеть,
// что именно проверяется и как выглядит вердикт.
    ...
    <section className="mx-auto max-w-3xl px-6 pb-4 pt-10">
      ...
      <div className="overflow-hidden rounded-2xl border border-border bg-card">
        <div className="border-b border-border px-5 py-4 sm:px-6">
          <p className="text-xs text-foreground/40">{fmtDate(run.finished_at)}</p>
